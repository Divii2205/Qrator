...
// Pre-defined sample ideas to avoid recreation on each render
const IDEAS_BY_TYPE = {
  video: [
...
const IdeaCard = React.memo(({ index, idea }) => (
  <div className="p-4 bg-slate-600/30 rounded-lg border border-slate-500/50 hover:border-blue-500/50 transition-all duration-300 group">
    <div className="flex items-start gap-4">
      ...
      <p className="text-white group-hover:text-blue-300 transition-colors duration-300">{idea}</p>
    </div>
  </div>
));
      ...
      <div className="min-h-[calc(100vh-80px)] mt-20 flex flex-col lg:flex-row w-full">
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-8 overflow-y-auto">
          <div className="max-w-2xl mx-auto">
            <div className="mb-8">
              <h1 className="text-white text-4xl font-bold mb-4">Content Idea Generator</h1>
              <p className="text-gray-300 text-lg">Transform your goals into engaging content ideas</p>
            </div>
            ...
            <div className="bg-slate-700/50 rounded-xl p-6 backdrop-blur-sm shadow-xl">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="tone" className="block text-white text-lg mb-2">
                    Content Tone
                  </label>
                  <select
                    id="tone"
                ...
                <div>
                  <label htmlFor="targetAudience" className="block text-white text-lg mb-2">
                    Target Audience
                  </label>
                  <input
                    type="text"
                ...
                <div className="relative">
                  <label htmlFor="goal" className="block text-white text-lg mb-2">
        ...
        <div className="w-full lg:w-1/2 p-6 lg:p-8 border-t lg:border-t-0 lg:border-l border-slate-600/50">
          <div className="max-w-2xl mx-auto">
            <div className="sticky top-24">
              <h2 className="text-white text-2xl font-semibold mb-6">Generated Ideas</h2>
              ...
              {isLoading && (
                <div className="bg-slate-700/30 rounded-xl p-8 text-center">
                  ...
                  <p className="text-gray-400 text-lg">Generating amazing ideas for you...</p>
                </div>
              )}
